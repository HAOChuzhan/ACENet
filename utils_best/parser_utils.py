...
def add_data_arguments(parser):
    ...
    parser.add_argument('--rel_emb', default='data/cpnet/glove.transe.sgd.rel.npy', help='paths to relation embedding file')
    # dataset specific
    parser.add_argument('-ds', '--dataset', default='csqa', choices=DATASET_LIST, help='dataset name')
    parser.add_argument('-nc', '--num_choice', default=5, type=int)
...
def add_optimization_arguments(parser):
    ...
    parser.add_argument('--warmup_steps', type=float, default=150) # 15epoches, warmsteps=150
